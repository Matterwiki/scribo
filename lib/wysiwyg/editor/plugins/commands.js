import { NODE_TYPES, DEFAULT_NODE } from '../../../common/constants';
    ...
    commands: {
      ...
      clearLists (editor) {
        if (editor.hasBlock(NODE_TYPES.LIST_ITEM)) {
          editor
            .unwrapBlock(NODE_TYPES.BULLETED_LIST)
      ...
      /**
       * Handles creation/updating link decorations on selected node
       *
       * @param {*} editor
       * @param {*} href
       */
      ...
      addOrRemoveList (editor, type) {
        ...
        if (isListItem && isType) {
          ...
          editor
            .unwrapBlock(
              type === NODE_TYPES.BULLETED_LIST
                ? NODE_TYPES.NUMBERED_LIST
                : NODE_TYPES.BULLETED_LIST
            )
            .wrapBlock(type);
        } else {
      ...
      increaseListDepth (editor) {
        ...
        return editor
          ...
          .wrapBlock(parent.type || NODE_TYPES.BULLETED_LIST)
          .focus();
      },
