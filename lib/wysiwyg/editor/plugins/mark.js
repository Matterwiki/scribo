...
export default function MarkPlugins (options) {
  return [
    ...
    MarkKeyBoardShortCutPlugin({
      keyCombination: 'mod+b',
      type: NODE_TYPES.BOLD
    }),
    MarkKeyBoardShortCutPlugin({
      keyCombination: 'mod+i',
      type: NODE_TYPES.ITALIC
    }),
    MarkKeyBoardShortCutPlugin({
      keyCombination: 'mod+u',
      type: NODE_TYPES.UNDERLINED
    }),
    MarkKeyBoardShortCutPlugin({
      keyCombination: 'mod+d',
      type: NODE_TYPES.STRIKETHROUGH
    }),
    MarkKeyBoardShortCutPlugin({
      keyCombination: 'mod+alt+c',
