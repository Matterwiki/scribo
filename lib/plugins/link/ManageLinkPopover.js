...
import { ToolbarPopoverIconButton } from "../../components/ToolbarPopoverButtons";
    ...
    render() {
        ...
        return (
            <StyledManageLinkContainer>
                ...
                />{" "}
                {urlExists && (
                    <ToolbarPopoverIconButton icon={FaExternalLinkAlt} onClick={this.openLink} />
                )}
                {urlExists && (
                    <ToolbarPopoverIconButton icon={FaUnlink} onClick={this.removeLink} />
                )}
            </StyledManageLinkContainer>
        );
    }
