...
export function renderNode(props, editor, next) {
    ...
    switch (node.type) {
        ...
        case NODE_TYPES.HEADING_ONE:
            return <HeadingOneNode {...attributes}>{props.children}</HeadingOneNode>;

        case NODE_TYPES.HEADING_TWO:
            return <HeadingTwoNode {...attributes}>{props.children}</HeadingTwoNode>;

        case NODE_TYPES.HEADING_THREE:
            return <HeadingThreeNode {...attributes}>{props.children}</HeadingThreeNode>;
