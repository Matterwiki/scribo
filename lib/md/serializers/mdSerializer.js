        ...
        nodes.forEach((n) => {
            if (n.object === "block") {
                const conversionFn = {
                    ...
                    [SERIALIZER_TYPES.ORDERED_LIST]: () => (n.type = SCRIBO_TYPES.NUMBERED_LIST),
                    [SERIALIZER_TYPES.CODE]: () => (n.type = SCRIBO_TYPES.CODE),
                    [SERIALIZER_TYPES.HEADING1]: () => (n.type = SCRIBO_TYPES.HEADING_ONE),
                    [SERIALIZER_TYPES.HEADING2]: () => (n.type = SCRIBO_TYPES.HEADING_TWO),
                    [SERIALIZER_TYPES.HEADING3]: () => (n.type = SCRIBO_TYPES.HEADING_THREE),
                    [SERIALIZER_TYPES.TABLE_HEAD]: () => (n.type = SCRIBO_TYPES.TABLE_CELL),
